...
This is a function file which does not need to be modified. You can use it as a black box.
The inputs to the function will be the signal amplitude 'a'(from 0 to 1), fundamental frequency 'F0'(100 to 4000 Hz), phase 'phi'(in radians) and duration 'T'(in ms) 
...
for plotting and playing the resulting signal  
